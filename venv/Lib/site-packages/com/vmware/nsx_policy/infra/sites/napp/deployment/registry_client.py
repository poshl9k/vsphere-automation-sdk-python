...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.sites.napp.deployment.registry.
#---------------------------------------------------------------------------
...
class Reset(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.sites.napp.deployment.registry.reset'
    """
...
class _ResetStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/policy/api/v1/infra/sites/{site-id}/napp/deployment/registry/reset',
            path_variables={
                'site_id': 'site-id',
            },
             header_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.sites.napp.deployment.registry.reset',

...
class AffectedIps(VapiInterface):
    """
    
    """

    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_ips'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _AffectedIpsStub)
    ...
    def create(self,
        ...
        :type  policy_ids_event_data_request: :class:`com.vmware.nsx_policy.model_client.PolicyIdsEventDataRequest`
        :param policy_ids_event_data_request: (required)
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyIdsIpList`
        ...
        return self._invoke('create',
                            {
                            'policy_ids_event_data_request': policy_ids_event_data_request,
                            'cursor': cursor,
...
class AffectedUsers(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_users'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyIdsUserList`
...
class AffectedVms(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_vms'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyIdsVmList`
...
class ClusterConfigs(VapiInterface):
    ...
    def get(self,
        ...
        :type  cluster_config_id: :class:`str`
        :param cluster_config_id: User entered ID (required)
...
class IdsEvents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.ids_events'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :type  policy_ids_event_data_request: :class:`com.vmware.nsx_policy.model_client.PolicyIdsEventDataRequest`
        :param policy_ids_event_data_request: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyIdsEventsBySignatureResult`
...
class IdsSummary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.ids_summary'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        The following filter criteria are supported: attack target, attack
        type, gateway name, IP address, product affected, signature ID and VM
        name.
        ...
        :type  sort_by: :class:`str` or ``None``
        :param sort_by: Field by which records are sorted (optional)
        :rtype: :class:`com.vmware.nsx_policy.model_client.PolicyIdsSummaryListResult`
...
class Stats(VapiInterface):
    ...
    """
    RESET_CATEGORY_IDPSEDGE = "IDPSEDGE"
    """
    Possible value for ``category`` of method :func:`Stats.reset`.
...
class _AffectedIpsStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'policy_ids_event_data_request': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsEventDataRequest'),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/affected-ips',
            request_body_parameter='policy_ids_event_data_request',
            path_variables={
            },
             header_parameters={
                         },
        ...
        operations = {
            'create': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsIpList'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_ips',
...
class _AffectedUsersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/affected-users',
            request_body_parameter='policy_ids_event_data_request',
            path_variables={
            },
             header_parameters={
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsUserList'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_users',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _AffectedVmsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/affected-vms',
            request_body_parameter='policy_ids_event_data_request',
            path_variables={
            },
             header_parameters={
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsVmList'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.affected_vms',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _ClusterConfigsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_input_type = type.StructType('operation-input', {
            'cluster_config_id': type.StringType(),
        })
        get_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/cluster-configs/{cluster-config-id}',
            path_variables={
                'cluster_config_id': 'cluster-config-id',
            },
             header_parameters={
               },
            query_parameters={
...
class _IdsEventsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/ids-events',
            request_body_parameter='policy_ids_event_data_request',
            path_variables={
            },
             header_parameters={
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsEventsBySignatureResult'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.ids_events',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _IdsSummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/ids-summary',
            request_body_parameter='policy_ids_event_data_request',
            path_variables={
            },
             header_parameters={
        ...
        operations = {
            'create': {
                'input_type': create_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsSummaryListResult'),
                'errors': create_error_dict,
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.ids_summary',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Stats': Stats,
        'profiles': 'com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.profiles_client.StubFactory',

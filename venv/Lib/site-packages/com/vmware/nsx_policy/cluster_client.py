...
class ApiService(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.cluster.api_service'
    """
    ...
    def get(self):
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.ApiServiceConfig`
    ...
    def update(self,
        ...
        :type  api_service_config: :class:`com.vmware.nsx_policy.model_client.ApiServiceConfig`
...
class _ApiServiceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/cluster/api-service',
            path_variables={
            },
             header_parameters={
             },
        ...
        update_input_type = type.StructType('operation-input', {
            'api_service_config': type.ReferenceType('com.vmware.nsx_policy.model_client', 'ApiServiceConfig'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'ApiServiceConfig'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.cluster.api_service',

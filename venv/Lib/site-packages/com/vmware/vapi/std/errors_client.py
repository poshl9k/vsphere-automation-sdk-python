...
class Error(VapiError):
    ...
    class Type(Enum):
        ...
        ERROR = None
        """
        Discriminator for the :class:`Error` type. This class attribute was added
        in vSphere API 6.7.2.

        """
        ALREADY_EXISTS = None
        """
        Discriminator for the :class:`AlreadyExists` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        ALREADY_IN_DESIRED_STATE = None
        """
        Discriminator for the :class:`AlreadyInDesiredState` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        CANCELED = None
        """
        Discriminator for the :class:`Canceled` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        CONCURRENT_CHANGE = None
        """
        Discriminator for the :class:`ConcurrentChange` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        FEATURE_IN_USE = None
        """
        Discriminator for the :class:`FeatureInUse` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        INTERNAL_SERVER_ERROR = None
        """
        Discriminator for the :class:`InternalServerError` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        INVALID_ARGUMENT = None
        """
        Discriminator for the :class:`InvalidArgument` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        INVALID_ELEMENT_CONFIGURATION = None
        """
        Discriminator for the :class:`InvalidElementConfiguration` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        INVALID_ELEMENT_TYPE = None
        """
        Discriminator for the :class:`InvalidElementType` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        INVALID_REQUEST = None
        """
        Discriminator for the :class:`InvalidRequest` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        NOT_ALLOWED_IN_CURRENT_STATE = None
        """
        Discriminator for the :class:`NotAllowedInCurrentState` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        NOT_FOUND = None
        """
        Discriminator for the :class:`NotFound` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        OPERATION_NOT_FOUND = None
        """
        Discriminator for the :class:`OperationNotFound` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        RESOURCE_BUSY = None
        """
        Discriminator for the :class:`ResourceBusy` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        RESOURCE_IN_USE = None
        """
        Discriminator for the :class:`ResourceInUse` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        RESOURCE_INACCESSIBLE = None
        """
        Discriminator for the :class:`ResourceInaccessible` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        SERVICE_UNAVAILABLE = None
        """
        Discriminator for the :class:`ServiceUnavailable` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        TIMED_OUT = None
        """
        Discriminator for the :class:`TimedOut` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        UNABLE_TO_ALLOCATE_RESOURCE = None
        """
        Discriminator for the :class:`UnableToAllocateResource` type. This class
        attribute was added in vSphere API 6.7.2.

        """
        UNAUTHENTICATED = None
        """
        Discriminator for the :class:`Unauthenticated` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        UNAUTHORIZED = None
        """
        Discriminator for the :class:`Unauthorized` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        UNEXPECTED_INPUT = None
        """
        Discriminator for the :class:`UnexpectedInput` type. This class attribute
        was added in vSphere API 6.7.2.

        """
        UNSUPPORTED = None
        """
        Discriminator for the :class:`Unsupported` type. This class attribute was
        added in vSphere API 6.7.2.

        """
        UNVERIFIED_PEER = None
        """
        Discriminator for the :class:`UnverifiedPeer` type. This class attribute
        was added in vSphere API 6.7.2.

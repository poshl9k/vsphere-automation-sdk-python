...
#
# vAPI stub file for package com.vmware.nsx.vpn.services.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.vpn.services.summary'
    """
    ...
    def get(self,
        ...
        GET
        /policy/api/v1/infra/tier-0s/<tier-0-id>/ipsec-vpn-services/<service-id>/summary
        GET
        /policy/api/v1/infra/tier-1s/<tier-1-id>/ipsec-vpn-services/<service-id>/summary
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/vpn/services/{service-id}/summary',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'IPSecVPNIKEServiceSummary'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.vpn.services.summary',

...
class Users(VapiInterface):
    ...
    def get(self,
        ...
        to the NSX appliance. The valid user IDs are: 0, 10000, 10002.
    ...
    def resetpassword(self,
        ...
        call to succeed. This API only supports user IDs 10002, 10003, and
        10004.
    ...
    def update(self,
        ...
        The valid user IDs are: 0, 10000, 10002. Note that invoking this API
        does not update any user-related properties of existing objects in the
        system and does not modify the username field in existing audit log
        entries.

...
#
# vAPI stub file for package com.vmware.nsx.switching_profiles.
#---------------------------------------------------------------------------
...
class Summary(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.switching_profiles.summary'
    """
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx.model_client.SwitchingProfileStatus`
...
class _SummaryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/switching-profiles/{switching-profile-id}/summary',
            path_variables={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'SwitchingProfileStatus'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.switching_profiles.summary',

...
class State(VapiInterface):
    ...
    def get(self,
        ...
        configuration and information about the associated hostswitch. This api
        is now deprecated. Please use new api -
    ...
    def list(self,
        ...
        provided as query parameter. This api will be deprecated in future. For
        Host, please use new api -

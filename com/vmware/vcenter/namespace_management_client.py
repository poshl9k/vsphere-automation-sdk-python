...
class ProxyConfiguration(VapiStruct):
    ...
    def __init__(self,
        ...
        :param tls_root_ca_bundle: Proxy TLS root CA bundle which will be used to verify the proxies
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param default_kubernetes_service_content_library: Identifier of the Content Library which holds the VM Images for
                ...
                class as a return value, the attribute will be an identifier for
                the resource type: ``com.vmware.content.Library``.
                If None, the Content Library will will not be modified.
            :type  workload_ntp_servers: :class:`list` of :class:`str` or ``None``
            :param workload_ntp_servers: List of NTP server DNS names or IP addresses to use for workloads
                such as Tanzu Kubernetes Grid VMs, specified in order of
                preference. This attribute was added in vSphere API 7.0.1.0.
...
class LoadBalancers(VapiInterface):
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param address_ranges: List of address ranges that will be used to derive frontend IP
                addresses for L4 virtual servers. At least one range must be
                provided. A set operation only allows for addition of new IP ranges
                to the existing list of IP ranges. This attribute was added in
                vSphere API 7.0.3.0.
            :type  provider: :class:`LoadBalancers.Provider`
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param address_ranges: List of address ranges that will be used to derive frontend IP
                ...
                ranges to the existing list of IP ranges. This attribute was added
...
class NSXTier0Gateway(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param tier0_gateway: Identifier of the Tier0 Gateway. This attribute was added in
                vSphere API 7.0.2.0.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``NSXTier0Gateway``. When methods return a value of this class as a
            ...
            :param display_name: Display name of the Tier0 Gateway. This attribute was added in
                vSphere API 7.0.2.0.
            """
...
class VirtualMachineClasses(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            invalid storage policy or if the input ``spec`` includes settings
            that are out of acceptable bounds or a combination of settings that
            are not internally consistent with the input ``spec``.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user can not be authenticated.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 

...
#
# vAPI stub file for package com.vmware.nsx_vmc_app.infra.linked_vpcs.
#---------------------------------------------------------------------------
...
class ConnectedServices(VapiInterface):
    ...
    def list(self,
        ...
        """
        List connected services to given linked vpc ID. The response consist of
        all available services along with their status.
...
class _ConnectedServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/cloud-service/api/v1/infra/linked-vpcs/{linked-vpc-id}/connected-services',
            path_variables={
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/cloud-service/api/v1/infra/linked-vpcs/{linked-vpc-id}/connected-services/{service-name}',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_vmc_app.infra.linked_vpcs.connected_services',

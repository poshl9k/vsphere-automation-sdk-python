...
class SecurityConfig(VapiInterface):
    ...
    def patch(self,
        ...
        update the security onfiguration.
...
class TlsInspectionConfigProfileBindings(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.infra.tier_1s.tls_inspection_config_profile_bindings'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def patch(self,
        ...
        """
        API will create or update TLS Config profile binding map for Tier-1
        Logical Router.
        ...
        :type  tls_inspection_config_profile_binding_id: :class:`str`
        :param tls_inspection_config_profile_binding_id: (required)
        :type  tls_config_profile_binding_map: :class:`com.vmware.nsx_policy.model_client.TlsConfigProfileBindingMap`
        :param tls_config_profile_binding_map: (required)
        :rtype: :class:`com.vmware.nsx_policy.model_client.TlsConfigProfileBindingMap`
        :return: com.vmware.nsx_policy.model.TlsConfigProfileBindingMap
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
             Bad Request, Precondition Failed
        ...
        return self._invoke('patch',
                            ...
                            'tier1_id': tier1_id,
                            'tls_inspection_config_profile_binding_id': tls_inspection_config_profile_binding_id,
                            'tls_config_profile_binding_map': tls_config_profile_binding_map,
                            })
...
class _TlsInspectionConfigProfileBindingsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/tier-1s/{tier1-id}/tls-inspection-config-profile-bindings/{tls-inspection-config-profile-binding-id}',
            path_variables={
                'tier1_id': 'tier1-id',
        ...
        patch_input_type = type.StructType('operation-input', {
            'tier1_id': type.StringType(),
            'tls_inspection_config_profile_binding_id': type.StringType(),
            'tls_config_profile_binding_map': type.ReferenceType('com.vmware.nsx_policy.model_client', 'TlsConfigProfileBindingMap'),
        })
        patch_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
        ...
        patch_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/policy/api/v1/infra/tier-1s/{tier1-id}/tls-inspection-config-profile-bindings/{tls-inspection-config-profile-binding-id}',
            request_body_parameter='tls_config_profile_binding_map',
            path_variables={
                'tier1_id': 'tier1-id',
                'tls_inspection_config_profile_binding_id': 'tls-inspection-config-profile-binding-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.tier_1s.tls_inspection_config_profile_bindings',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

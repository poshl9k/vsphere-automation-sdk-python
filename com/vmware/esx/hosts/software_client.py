...
class InstalledComponents(VapiInterface):
    ...
    class ProductLine(Enum):
        """
        The ``InstalledComponents.ProductLine`` class defines product line. Product
        line are used to specify the platform vib is built for.
        ...
        def __init__(self, string):
            ...
            :param string: String value for the :class:`ProductLine` instance.
            """
            Enum.__init__(string)

    ProductLine._set_values([
        ProductLine('EMBEDDED_ESX'),
        ProductLine('ESX_IO'),
    ])
    ProductLine._set_binding_type(type.EnumType(
        'com.vmware.esx.hosts.software.installed_components.product_line',
        ProductLine))

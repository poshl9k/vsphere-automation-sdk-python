...
class SupportBundle(VapiInterface):
    """
    The ``SupportBundle`` class provides methods to create support bundle task,
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'status',
                {
                    'SUCCEEDED' : [('generation_time', True), ('url', True), ('expiration_time', True), ('downloadable', True), ('size', True)],
